...
void hud_render(SDL_Renderer *renderer, int screen_w, int screen_h, int health, int ammo, int reserve_ammo, int score, int enemies_remaining, int level, const Texture face_tex[HUD_FACE_COUNT]) {
    ...
    font_draw_string(renderer, level_buf, bar_x, bar_y + 4, white);
