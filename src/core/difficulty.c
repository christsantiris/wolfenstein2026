...
static const DifficultyDef DIFFICULTIES[DIFF_COUNT] = {
    ...
    [DIFF_DONT_HURT_ME] = {
        ...
        .name = "DONT HURT ME.",
        .enabled = 1,
        .enemy_health_multiplier = 0.875f,
        .enemy_speed_multiplier = 0.90f,
        .enemy_sight_multiplier = 0.90f,
        .enemy_damage_multiplier = 0.80f,
        .health_pickup_amount = 33,
        .ammo_pickup_amount = 12,
        .weapon_unlock_spare_magazines = 3,
        .level_start_health_floor = 100,
        .kill_score = 88,
        .boss_max_health = 1400,
        .miniboss_max_health = 831,
        .miniboss_support_count = 2,
        .miniboss_wave_count = 2,
        .boss_support_count = 3,
        .boss_wave_count = 2
